...
let menuGrid, cartSidebar, overlay, cartCount, cartItems, cartTotal, checkoutModal, modalOrderSummary, modalTotalPrice, customerNameInput, tableNumberInput, modalCustomerDetails;
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    customerNameInput = document.getElementById('customerName'); // Tambahkan ini
    tableNumberInput = document.getElementById('tableNumber');   // Tambahkan ini
    modalCustomerDetails = document.getElementById('modalCustomerDetails'); // Tambahkan ini
...
function checkout() {
    ...
    // Validasi input detail pelanggan
    if (!customerName || !tableNumber) {
        alert('Mohon lengkapi Nama dan Nomor Meja sebelum memesan.');
        return;
    }
    ...
    // Tampilkan detail pelanggan di modal
    modalCustomerDetails.innerHTML = `
        <p><strong class="text-gray-800">Nama Pelanggan:</strong> ${customerName}</p>
        <p><strong class="text-gray-800">Nomor Meja:</strong> ${tableNumber}</p>
    `;
